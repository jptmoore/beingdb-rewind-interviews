...
uses_medium(mandala, analogue_feedback).
uses_medium(mandala, digital_feedback).
uses_medium(mandala, digital_processing).
...
uses_medium(videokalos, colour_video).
uses_medium(videokalos, vision_mixer).
