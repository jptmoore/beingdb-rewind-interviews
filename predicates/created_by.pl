...
created_by(scratch_pieces, george_barber).
created_by(scratch_video_volume_1, george_barber).
created_by(scratch_video_volume_2, george_barber).
...
created_by(upside_down, george_barber).
created_by(venetian_ghost, george_barber).
