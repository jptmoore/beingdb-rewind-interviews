% contributed_text facts generated by beingdb-rewind-interviews (npm run extract).
...
contributed_text(josine_van_droffelaar, audio_video_installations_catalogue).
